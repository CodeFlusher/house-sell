<template>
  <div class="w-full">
    ...
    <KitTransparentCard class=" w-fit absolute opacity-0 scale-y-0 h-fit text-style-title transition-all duration-300 ease-in-out text-xl" :class="{'translate-y-2 scale-y-100 opacity-100': isContextShown}" :overrideclass="overrideClass" >
