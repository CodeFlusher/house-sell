<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mx-auto p-4 mt-8">
    <div class="p-2 my-auto">
      <h2 class="text-style-title text-4xl">{{$t('ui.pages.main.questions.title')}}</h2>
    ...
    <form action="" class="gap-2 grid grid-cols-1 grid-">
      <InputTitled :input="email" type="text" :enabled="true" :title="$t('ui.input.email.title')" :placeholder="$t('ui.input.email.placeholder')"></InputTitled>
